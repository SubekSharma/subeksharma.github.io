...
//  </div>
  const educationItem = `
 <div class="flex flex-col h-[400px] border border-red-500 w-full  py-4">
   ...
   />
     ...
     <div class="text-2xl flex-1 border-b border-[#5e17eb] text-serif flex items-center justify-center text-center">
       <h3>
